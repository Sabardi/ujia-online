<x-app-layout>
    <div id="menu-content" class="flex flex-col w-full pb-[30px]">
        ...
        <form action="{{ route('dashboard.course.create.question.store', $course->id) }}" method="POST" id="add-question"
            ...
            <div class="flex flex-col gap-[10px]">
                ...
                <div
                    ...
                    <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                        <img src="{{ asset('assets') }}/images/icons/note-text.svg" class="object-contain w-full h-full"
                            alt="icon">
                    </div>
                    <input type="text"
                        class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
                ...
                @for ($i = 1; $i <= 4; $i++)
                    <div class="flex items-center gap-4">
                        <div
                            class="flex items-center w-[500px] h-[52px] p-[14px_16px] rounded-full border border-[#EEEEEE] focus-within:border-2 focus-within:border-[#0A090B]">
                            <div class="mr-[14px] w-6 h-6 flex items-center justify-center overflow-hidden">
                                <img src="{{ asset('assets') }}/images/icons/edit.svg" class="object-contain w-full h-full"
                                    alt="icon">
                            </div>
                            <input type="text"
                                class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
