...
<body class="font-poppins text-[#0A090B]">
    <section id="content" class="flex">
        ...
        @endif
            ...
            <form action="{{ route('dashboard.course_question.update', $courseQuestion) }}" method="POST" id="add-question" class="mx-[70px] mt-[30px] flex flex-col gap-5">
                @csrf
                @method('PUT')
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div
                        ...
                        <input type="text"
                            class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
                            placeholder="Write the question" name="question" value="{{ $courseQuestion->question }}">
                    </div>
                </div>
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div class="flex items-center gap-4">
                        <div
                            ...
                            <input type="text"
                                class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
                                placeholder="Write better answer option" name="answer[]" value="{{ $answer->answer }}">
                        </div>
