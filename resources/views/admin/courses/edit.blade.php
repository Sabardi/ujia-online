    ...
    <section id="content" class="flex">
        ...
        <div id="menu-content" class="flex flex-col w-full pb-[30px]">
            ...
            <form action="{{ route('dashboard.courses.update', $course->id) }}" method="post"
                enctype="multipart/form-data" class="flex flex-col gap-[30px] w-[500px] mx-[70px] mt-10">
                @csrf
                @method('PUT')
                <div class="flex items-center gap-5">
                    <input type="file" name="cover" id="icon" class="hidden peer"
                    ...
                    <div
                        ...
                        <div class="relative z-10 w-full h-full file-preview">
                            <img src="{{ Storage::url($course->cover) }}"
                                class="object-cover w-full h-full thumbnail-icon" alt="thumbnail">
                        </div>
                        <span
                ...
                <div class="flex flex-col gap-[10px]">
                    ...
                    <div
                        ...
                        <input type="text"
                            class="font-semibold placeholder:text-[#7F8190] placeholder:font-normal w-full outline-none"
                            placeholder="Write your better course name" name="name" value="{{ $course->name }}"
                            required>
                    </div>
                </div>
