...
<body class="font-poppins text-[#0A090B]">
    <section id="content">
        ...
        <div class="finished flex flex-col gap-[40px] items-center justify-center mt-[120px] mb-[30px] w-full">
            ...
            <a href="{{ route('dashboard.learning.finished.rapport', $course->id ) }}" class="w-fit p-[14px_30px] bg-[#6436F1] rounded-full font-bold text-sm text-white transition-all duration-300 hover:shadow-[0_4px_15px_0_#6436F14D] text-center align-middle">View Test Result</a>
        </div>
    </section>
